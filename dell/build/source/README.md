...
The build pipeline is defined in `workshop.yaml`. It copies the source to a build directory and runs `dpkg-buildpackage` inside a container with all required dependencies.
